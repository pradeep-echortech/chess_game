...
function Soldier(row, col, color = 'white') {
    ...
    return {
        name: `${color} Soldier`,
        icon: `<img src='/assets/${color}-soldier.png'/>`,
        color,
        getPossibleMoves: () => {
            let possibleMoves = []
...
function Elephant(row, col, color = 'white') {
    ...
    return {
        name: `${color} Elephant`,
        icon: `<img src='/assets/${color}-rook.png'/>`,
        color,
        getPossibleMoves: () => {
            let possibleMoves = []
            for (let i = x + 1; i < 8; i++) {
...
function Camel(row, col, color = 'white') {
    ...
    return {
        name: `${color} Camel`,
        icon: `<img src='/assets/${color}-bishop.png'/>`,
...
function Horse(row, col, color = 'white') {
    ...
    return {
        name: `${color} Horse`,
        icon: `<img src='/assets/${color}-knight.png'/>`,
...
function King(row, col, color = 'white') {
    ...
    return {
        name: `${color} King`,
        icon: `<img src='/assets/${color}-king.png'/>`,
...
function Queen(row, col, color = 'white') {
    ...
    return {
        name: `${color} Queen`,
        icon: `<img src='/assets/${color}-queen.png'/>`,
...
const move = `<img src="/assets/move.png" class="move"/>`
...
function formdata() {
    ...
    if (ele.getPossibleMoves().find(arr => arr[0] == y1 && arr[1] == x1)){
        ele.moveTo(y1, x1)
        currentTurn = currentTurn == "white" ? "black" : "white"
        playerTurn.innerHTML = `${currentTurn}'s turn`
        possibleMoves = []
        moveEle.value = '';
        renderBoardFromState()
    }
