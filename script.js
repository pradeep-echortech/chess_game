...
function Soldier(row, col, color = 'white') {
    ...
    return {
        name: `${color} Soldier`,
        icon: `<img src='${color}-soldier.png'/>`,
        color,
        getPossibleMoves: () => {
            let possibleMoves = []
...
const move = `<img src="move.png" class="move"/>`
